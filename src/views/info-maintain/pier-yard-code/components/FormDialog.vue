<template>
  ...
  >
    <el-form ref="form" :model="form" :rules="rules">
      ...
      <el-form-item label="码头/货场" prop="name">
        <el-input v-model.trim="form.name" placeholder="请输入码头/货场" />
      </el-form-item>
    </el-form>
    <div slot="footer">
...
<script>
import { pierYardCode as api } from "@/api/info-maintain";
export default {
  data() {
    return {
      visible: false,
      ...
      rules: {
        ...
        name: [{ required: true, message: "请输入码头/货场" }]
      },
      editing: false
    };
  },
